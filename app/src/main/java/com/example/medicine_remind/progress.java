        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_progress:
                    Intent intent_progress = new Intent(progress.this,progress.class);
                    startActivity(intent_progress);
                    break;
                case  R.id.btn_team:
                    Intent intent_team = new Intent(progress.this,team.class);
                    startActivity((intent_team));
                    break;
                case  R.id.btn_my_treatment:
                    Intent intent_mytreatment = new Intent(progress.this,mytreatment.class);
